...
LOCAL_MODULE := android.hardware.power-service.xiaomi-lmi
LOCAL_INIT_RC := android.hardware.power-service.xiaomi-lmi.rc
LOCAL_MODULE_TAGS := optional
LOCAL_VENDOR_MODULE := true
LOCAL_VINTF_FRAGMENTS := android.hardware.power-service.xiaomi-lmi.xml
